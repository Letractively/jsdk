...
js.ui.menu.PopupMenuLite=function(owner,mode){
	...
	this._version="1.4.4 Final 20110812";
...
with(_$class.Item){
	...
	prototype._onActivate=function(oEvent){
		with(this._htmlElement){
			if(Browser.Engine.trident) setAttribute("className","PopupMenuItem ActivePopupMenuItem");
			else setAttribute("class","PopupMenuItem ActivePopupMenuItem");
		}
