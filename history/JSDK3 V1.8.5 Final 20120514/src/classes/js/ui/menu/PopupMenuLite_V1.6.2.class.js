...
js.ui.menu.PopupMenuLite=function(owner,mode){
	...
	this._version="1.6.2 Final 20110822";
...
with(_$class){
	...
	_$class._styleLib={
		"classic" : Engine.runtimeEnvironment.getResPath("js.ui.menu")
					+"/PopupMenuLite_V1.6.2/"+(Browser.Engine.trident&&document.compatMode!="CSS1Compat"?"Classic.IE.css":"Classic.css"),
		"xp": Engine.runtimeEnvironment.getResPath("js.ui.menu")
					+"/PopupMenuLite_V1.6.2/"+(Browser.Engine.trident&&document.compatMode!="CSS1Compat"?"XP.IE.css":"XP.css")
	}
